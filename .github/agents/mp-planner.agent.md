...
**IMPORTANT**: Use the `mp-plan` skill (`.github/skills/mp-plan/SKILL.md`) to plan technical solutions and create comprehensive plans in Markdown format.
...
4. Remind user: "Use `mp-execute` skill to execute this plan"

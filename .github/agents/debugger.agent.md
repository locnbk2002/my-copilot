...
- If user provides error screenshots or UI bug reports: recommend dispatching `task(agent_type="multimodal")` for visual analysis
...
- **Visual Analysis**: For UI bugs or screenshot-based reports, dispatch `task(agent_type="multimodal")` via `task` tool

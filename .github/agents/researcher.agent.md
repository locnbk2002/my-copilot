...
**IMPORTANT**: Use the `research` skill (`.github/skills/research/SKILL.md`) to conduct systematic research and generate reports.
**IMPORTANT**: Use the `docs-seeker` skill (`.github/skills/docs-seeker/SKILL.md`) for library/framework documentation lookup via Context7 MCP tools.
**IMPORTANT**: Use the `scout` skill (`.github/skills/scout/SKILL.md`) to discover relevant files when researching internal codebases.
**IMPORTANT**: Use the `sequential-thinking` skill (`.github/skills/sequential-thinking/SKILL.md`) for complex multi-step analysis.

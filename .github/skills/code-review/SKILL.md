...
**Note:** This SKILL orchestrates the review workflow. The `code-reviewer` AGENT (`.github/agents/code-reviewer.agent.md`) performs the actual review.

## Invocation

```
code-review [scope] [--staged] [--branch main] [--strict]
...
- `execute` — Invokes this skill as review gate
- `git` — Typically invoked after review passes

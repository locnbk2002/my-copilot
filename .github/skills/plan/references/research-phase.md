...
### Sequential Thinking
- Use the `sequential-thinking` skill (`.github/skills/sequential-thinking/SKILL.md`) for structured, reflective problem-solving
...
- Use the `docs-seeker` skill (`.github/skills/docs-seeker/SKILL.md`) to find library/framework documentation via Context7 MCP tools
...
When given a GitHub repository URL and Context7 has no results, use `docs-seeker` fallback (`repo-analysis.md`) or:
```bash

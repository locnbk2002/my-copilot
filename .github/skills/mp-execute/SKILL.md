...
argument-hint: "[plan-path] [--phase N] [--skip-tests] [--skip-review]"
license: MIT
---
...
```
mp-execute [plan-path] [--phase N] [--skip-tests] [--skip-review]

Default: Execute all phases sequentially with test/review gates
...
4. **Implement** — Follow the phase instructions:

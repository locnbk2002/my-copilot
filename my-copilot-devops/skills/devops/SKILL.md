...
**Security:** Non-root containers, RBAC, secrets in env vars, image scanning. Never commit secrets to CI/CD pipelines — use GitHub Secrets, Cloudflare Secrets, or GCP Secret Manager for all sensitive values.

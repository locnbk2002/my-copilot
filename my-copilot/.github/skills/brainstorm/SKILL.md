...
```
brainstorm [topic] [--visual] [--report]
...
- `sequential-thinking` — Step-by-step analysis of complex tradeoffs
- `multimodal` agent — Analyze mockups, diagrams, and visual references

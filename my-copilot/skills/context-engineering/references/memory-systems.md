> **Note:** Some concepts in this reference assume Claude Code's memory and agent infrastructure. In copilot-cli contexts, treat these sections as advisory patterns rather than executable workflows.

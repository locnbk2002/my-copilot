...
If invoked without arguments, use `ask_user` to present available preview operations:
...
Present as options via `ask_user` with header "Preview Operation", question "What would you like to do?".

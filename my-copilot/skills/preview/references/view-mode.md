...
The skill is located at `.github/skills/markdown-novel-viewer/`.
...
```bash
node .github/skills/markdown-novel-viewer/scripts/server.cjs --stop
```
...
if [[ -d "$INPUT_PATH" ]]; then
  node .github/skills/markdown-novel-viewer/scripts/server.cjs \
